 ...
 ******************************************************************************/
package net.enilink.rap.internal.workbench;
...
public class SnippetRunner implements EntryPoint {
	...
	private static final String PACKAGE_PREFIX = "net.enilink.rap.snippets";
	...
	private void runSnippet(Class<?> snippetClass) {
		if (EntryPoint.class.isAssignableFrom(snippetClass)) {
			...
			if (method == null) {
				String message = "The class " + snippetClass.getName()
