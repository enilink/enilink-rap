 ...
 */
public class BasicModelEditorBarContributor extends
	...
	protected IAction refreshViewerAction = new Action(
			EnilinkWorkbenchPlugin.INSTANCE
	...
	protected IAction showPropertiesViewAction = new Action(
		...
		public void run() {
			try {
				...
				EnilinkWorkbenchPlugin.INSTANCE.log(exception);
			}
		}
	};
	 ...
	 */
	public BasicModelEditorBarContributor() {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager editorMenuManager = new MenuManager(
				EnilinkWorkbenchPlugin.INSTANCE
						.getString("_UI_BasicEditor_menu"),
				"BasicEditor");
		...
		// do not add menu bar action since their computation can be slow
